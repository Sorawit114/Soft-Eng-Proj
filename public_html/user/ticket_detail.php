...
$sql = "SELECT t.*, e.name AS event_name, e.image AS event_image, e.location AS event_location, e.event_id,
...
>
  ...
  <main class="flex flex-col items-center justify-center py-10">
        ...
        <div class="space-y-10 w-full max-w-3xl py-10">
              <!-- Ticket Card -->
              <div class="bg-white text-black rounded-xl shadow-md p-8 min-h-[200px] w-full">
		<div class="flex flex-col md:flex-row justify-between">
 		  ...
 		  <p class="mt-2 text-2xl text-mainBlue font-semibold md:w-1/2 text-center">
			...
			<?php
			echo '<a href="review.php?ticket_id=' . $ticket['id'] . '&event_id=' . $ticket['event_id'] . '" class="inline-block bg-green-600 text-white mt-2 px-6 py-2 rounded-full hover:bg-green-700 transition-colors shadow-md font-semibold">Review</a>';
			?>
